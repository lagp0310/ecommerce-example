    ...
    <div className="my-6 flex flex-1 flex-col gap-y-6">
      ...
      <div className="flex flex-1 flex-col justify-center gap-y-6 px-6 xl:px-0">
        <div className="flex flex-1 flex-row items-center justify-center">
          <div className="flex max-w-7xl flex-1 flex-col md:flex-row md:items-center md:justify-center gap-6">
            <Skeleton className="h-80 w-full md:basis-2/3 rounded-ten" />
            <Skeleton className="h-80 w-full md:basis-1/3 rounded-ten" />
          </div>
        </div>
      </div>
    </div>
